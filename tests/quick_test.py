...
async def test_download_agent():
    ...
    try:
        ...
        douyin = "https://www.douyin.com/video/7621159941025353010?modeFrom="
        bilibili = "https://www.bilibili.com/video/BV1HxQSBgEvC/?spm_id_from=333.1007.tianma.1-1-1.click&vd_source=e31cce80093b828b7dbe25383a0ead44"
        xiaohongshu = "https://www.xiaohongshu.com/explore/64ad5214000000001c00cf63?source=webshare&xhsshare=pc_web&xsec_token=AB8XxhD7hIPjXeHj7oPqfv4TQKDWRHoVtDxVepU9HUDWE=&xsec_source=pc_share"

        urls = [kuaishou, douyin, bilibili, xiaohongshu]
...
async def test_extract_agent():
    ...
    try:
        ...
        if api_key:
            ...
            print("✅ 提取代理初始化成功 (使用环境变量API密钥)")
        else:
            agent = ExtractAgent("test-key")
            print("✅ 提取代理初始化成功 (使用测试密钥)")
